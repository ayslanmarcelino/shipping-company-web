...
Funcionalidade: Realizar Login como financeiro
  ...
  @login_com_sucesso_como_usuario_financeiro

  Cenário: Realizar login com sucesso com usuário financeiro
    E tenha um usuário "financial"
    ...
    Então quero visualizar o menu disponível para o usuário financeiro
