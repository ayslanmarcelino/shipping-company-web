...
@regra_de_usuario_como_master

Funcionalidade: Visualizar regras de usuário cadastradas na plataforma como master
  ...
  @visualizar_regra_de_usuario_como_master

  Cenário: Visualizar regras de usuário cadastradas
    Então quero visualizar a página de regras de usuário como usuário master

  @apagar_regra_de_usuario_como_master
  ...
  @visualizar_editar_regra_de_usuario_como_master
